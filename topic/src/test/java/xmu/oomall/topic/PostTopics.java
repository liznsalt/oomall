...
public class PostTopics {
    ...
    public void test1() throws Exception{
        ...
        HttpEntity httpEntity = new HttpEntity(topic, httpHeaders);
        ...
        TopicPo testTopics = JacksonUtil.parseObject(body, "data", TopicPo.class);
        assertEquals(topic.getContent(), testTopics.getContent());
    }
}
